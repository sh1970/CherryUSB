...
int usbh_enumerate(struct usbh_hubport *hport)
{
    ...
    USB_LOG_INFO("The device has %d bNumConfigurations and selects index %d as default\r\n", ((struct usb_device_descriptor *)ep0_request_buffer[hport->bus->busid])->bNumConfigurations, config_index);
